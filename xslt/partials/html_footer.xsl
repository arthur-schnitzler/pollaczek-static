            ...
            <div class="container" id="footer-full-content" tabindex="-1">
                ...
                <div class="row">
                    ...
                    <div class="footer-widget col-lg-3 col-md-4 col-sm-3 ml-auto">
                        <div class="row">
                        <div class="textwidget custom-html-widget">
                            <a href="https://www.wienbibliothek.at/" target="_blank"><img src="/img/wienbibliothek.jpg" class="image" alt="Wienbibliothek Logo" style="max-width: 100%; height: auto;" title="Wienbibliothek Logo"/></a>
                        </div>
                        <div class="textwidget custom-html-widget">
